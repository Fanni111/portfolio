...
export class WorkPageComponent implements OnInit {
  ...
  constructor(deviceDetector: DeviceDetectorService) { 
    ...
    ["assets/images/motiondesign/motivapp_teacher_phone.png", "assets/images/motiondesign/motivapp_img_01.png", "assets/images/motiondesign/motivapp_img_02.png", "assets/images/motiondesign/motivapp_img_03.png", "assets/images/motiondesign/motivapp_img_04.png", "assets/images/motiondesign/motivapp_img_05.png"], "https://www.youtube.com/embed/g6hJ4Z_0j64");
    ...
    ["assets/images/motiondesign/vizio_img_01.png", "assets/images/motiondesign/vizio_img_02.png", "assets/images/motiondesign/vizio_img_03.png"], "https://www.youtube.com/embed/0LlYQ1deEZY");
    ...
    ["assets/images/motiondesign/munkavedelem_img_01.png", "assets/images/motiondesign/munkavedelem_img_02.png", "assets/images/motiondesign/munkavedelem_img_03.png"], "https://www.youtube.com/embed/uM3WDlBJJF4");
  ...
  this.neptanc = new ProjectItem("assets/images/videography/neptanc.jpg","Fehérvári néptáncfesztivál", "Videography","A székesfehérvári királyi napok alatt nemzetközi táncosok hangulatos felvonulással, táncokkal és látványos gálával szórakoztatták a közönséget. A legszebb pillanatokról hangulatvideót készítettem.",
    ...
    ["assets/images/videography/budapest_01.png", "assets/images/videography/budapest_02.png", "assets/images/videography/budapest_03.png", "assets/images/videography/budapest_04.png"],
